/**
 * BTC/GBP 15M Scalp signal detector (Coinbase via CCXT).
...
function checkBTCGBPScalp(candles15m, candles6h) {
  if (!candles15m || candles15m.length < 10) { console.log('[BTC/GBP Scalp] Not enough 15M candles'); return null; }
  if (!candles6h  || candles6h.length  < 50) { console.log('[BTC/GBP Scalp] Not enough 6H candles'); return null; }
  ...
  console.log(
    `[BTC/GBP Scalp] 6H Trend: ${trend} | 15M Momentum: ${momentum} | ` +
...
function checkBTCGBPScalpBrewing(candles15m, candles6h) {
...
module.exports = { checkBTCGBPScalp, checkBTCGBPScalpBrewing };
