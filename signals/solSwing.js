/**
 * SOL/USD 6H Swing signal detector (Coinbase via CCXT).
 */
...
function checkSOLSwing(candles) {
  if (!candles || candles.length < LOOKBACK + 10) {
    console.log('[SOL/USD Swing] Not enough candles');
    return null;
  }
  ...
  console.log(
    `[SOL/USD Swing] Close: ${currentClose.toFixed(2)} | ` +
...
function checkSOLSwingBrewing(candles) {
...
module.exports = { checkSOLSwing, checkSOLSwingBrewing };
