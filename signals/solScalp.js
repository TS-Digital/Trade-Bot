/**
 * SOL/USD 15M Scalp signal detector (Coinbase via CCXT).
...
function checkSOLScalp(candles15m, candles6h) {
  if (!candles15m || candles15m.length < 10) { console.log('[SOL/USD Scalp] Not enough 15M candles'); return null; }
  if (!candles6h  || candles6h.length  < 50) { console.log('[SOL/USD Scalp] Not enough 6H candles'); return null; }
  ...
  console.log(
    `[SOL/USD Scalp] 6H Trend: ${trend} | 15M Momentum: ${momentum} | ` +
...
function checkSOLScalpBrewing(candles15m, candles6h) {
...
module.exports = { checkSOLScalp, checkSOLScalpBrewing };
